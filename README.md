...
Call `AdTogether.initialize()` **before** `runApp()`. You can obtain your App ID from the [AdTogether Dashboard](https://www.ad-together.org/dashboard).
